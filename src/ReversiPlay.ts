...
namespace ReversiPlayWrap {
  ...
  module.exports = class ReversiPlay {
    ...
    private mDelegate: typeof ReversiPlayDelegate; //!< デリゲート
    private mCallbacks: typeof CallbacksJson; //!< コールバック
    ...
    public constructor() {
      ...
      for (
        var i = 0;
        i <
        ReversiConst.DEF_MASU_CNT_MAX_VAL * ReversiConst.DEF_MASU_CNT_MAX_VAL;
        i++
      ) {
    ...
    public gameEndAnimExec(): number {
      ...
      if (this.mSetting.mEndAnim == ReversiConst.DEF_END_ANIM_ON) {
        ...
        for (var i = 0; i < this.mSetting.mMasuCnt; i++) {
          for (var j = 0; j < this.mSetting.mMasuCnt; j++) {
            this.mReversi.setMasuStsForcibly(
    ...
    private drawSingle(
      ...
      if (this.mDelegate != null && this.mCallbacks != null) {
        if (text == "0") text = "";
        this.mCallbacks.Funcs.push(
          this.mDelegate.drawSingle(y, x, sts, bk, text)
        );
      }
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////
    /**	@brief			セッター
     *	@fn         public setmDelegate(mDelegate: ReversiPlayDelegate): void
     ...
     */
    ////////////////////////////////////////////////////////////////////////////////
    public setmDelegate(mDelegate: typeof ReversiPlayDelegate): void {
      this.mDelegate = mDelegate;
    }

    ////////////////////////////////////////////////////////////////////////////////
    /**	@brief		ゲッター
     *	@fn				public getmDelegate(): ReversiPlayDelegate
     *	@return		デリゲート
     *	@author		Yuta Yoshinaga
     *	@date			2020.07.25
     */
    ////////////////////////////////////////////////////////////////////////////////
    public getmDelegate(): typeof ReversiPlayDelegate {
      return this.mDelegate;
    }

    ////////////////////////////////////////////////////////////////////////////////
    /**	@brief			セッター
     *	@fn         public setmCallbacks(mCallbacks: CallbacksJson): void
     ...
     */
    ////////////////////////////////////////////////////////////////////////////////
    public setmCallbacks(mCallbacks: typeof CallbacksJson): void {
      this.mCallbacks = mCallbacks;
    }

    ////////////////////////////////////////////////////////////////////////////////
    /**	@brief		ゲッター
     *	@fn				public getmCallbacks(): CallbacksJson
     *	@return		デリゲート
     *	@author		Yuta Yoshinaga
     *	@date			2020.07.25
     */
