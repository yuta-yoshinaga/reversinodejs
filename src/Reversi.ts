...
let ReversiAnz2 = require("./ReversiAnz");
let ReversiPoint2 = require("./ReversiPoint");
let ReversiHistory = require("./ReversiHistory");
let ReversiConst2 = require("./ReversiConst");
...
module.exports = class Reversi {
  ...
  public constructor(masuCnt: number, masuMax: number) {
    ...
    for (var i = 0; i < this.mMasuCntMax; i++) {
      ...
      for (var j = 0; j < this.mMasuCntMax; j++) {
        this.mMasuSts[i][j] = ReversiConst2.REVERSI_STS_NONE;

        this.mMasuStsEnaB[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsCntB[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsPassB[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsAnzB[i][j] = new ReversiAnz2();

        this.mMasuStsEnaW[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsCntW[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsPassW[i][j] = ReversiConst2.REVERSI_STS_NONE;
        this.mMasuStsAnzW[i][j] = new ReversiAnz2();
      }
    }
    this.mMasuPointB = new Array();
    this.mMasuPointW = new Array();
    for (var i = 0; i < this.mMasuCntMax * this.mMasuCntMax; i++) {
      this.mMasuPointB[i] = new ReversiPoint2();
      this.mMasuPointW[i] = new ReversiPoint2();
    }
  ...
  public reset(): void {
	...
	this.mMasuSts[idx1][idx1] = ReversiConst2.REVERSI_STS_BLACK;
    this.mMasuSts[idx1][idx2] = ReversiConst2.REVERSI_STS_WHITE;
    this.mMasuSts[idx2][idx1] = ReversiConst2.REVERSI_STS_WHITE;
    this.mMasuSts[idx2][idx2] = ReversiConst2.REVERSI_STS_BLACK;
    this.makeMasuSts(ReversiConst2.REVERSI_STS_BLACK);
    this.makeMasuSts(ReversiConst2.REVERSI_STS_WHITE);
    this.mMasuHistCur = 0;
    this.mMasuStsOld = extend(true, [], this.mMasuSts);
  }
  ...
  private makeMasuSts(color: number): number {
    ...
    for (var i = 0; i < this.mMasuCnt; i++) {
      // 初期化
      for (var j = 0; j < this.mMasuCnt; j++) {
        if (color == ReversiConst2.REVERSI_STS_BLACK) {
    ...
    for (var i = 0; i < this.mMasuCnt; i++) {
      for (var j = 0; j < this.mMasuCnt; j++) {
        okflg = 0;
        count2 = 0;
        if (this.mMasuSts[i][j] == ReversiConst2.REVERSI_STS_NONE) {
          // 何も置かれていないマスなら
          cnt1 = i;
          count1 = flg = 0;
          // *** 上方向を調べる *** //
          while (
            cnt1 > 0 &&
            this.mMasuSts[cnt1 - 1][j] != ReversiConst2.REVERSI_STS_NONE &&
          ...
          while (
            ...
            this.mMasuSts[i][cnt2 + 1] != ReversiConst2.REVERSI_STS_NONE &&
          ...
          while (
            cnt2 < this.mMasuCnt - 1 &&
            cnt1 > 0 &&
            this.mMasuSts[cnt1 - 1][cnt2 + 1] != ReversiConst2.REVERSI_STS_NONE &&
        ...
        } else if (this.mMasuSts[i][j] == ReversiConst2.REVERSI_STS_BLACK) {
          this.mMasuBetCntB++;
        } else if (this.mMasuSts[i][j] == ReversiConst2.REVERSI_STS_WHITE) {
          this.mMasuBetCntW++;
        }
      }
    }
  ...
  private revMasuSts(color: number, y: number, x: number): void {
    ...
    for (flg = 0, cnt1 = x, cnt2 = y; cnt1 > 0; ) {
      if (
        this.mMasuSts[cnt2][cnt1 - 1] != ReversiConst2.REVERSI_STS_NONE &&
        ...
        flg = 1;
        break;
      } else if (this.mMasuSts[cnt2][cnt1 - 1] == ReversiConst2.REVERSI_STS_NONE) {
        break;
      }
    }
    if (flg == 1) {
    ...
    for (flg = 0, cnt1 = x, cnt2 = y; cnt2 > 0; ) {
      if (
        this.mMasuSts[cnt2 - 1][cnt1] != ReversiConst2.REVERSI_STS_NONE &&
        ...
        flg = 1;
        break;
      } else if (this.mMasuSts[cnt2 - 1][cnt1] == ReversiConst2.REVERSI_STS_NONE) {
        break;
      }
    }
    if (flg == 1) {
    ...
    for (flg = 0, cnt1 = x, cnt2 = y; cnt2 > 0 && cnt1 > 0; ) {
      if (
        this.mMasuSts[cnt2 - 1][cnt1 - 1] != ReversiConst2.REVERSI_STS_NONE &&
        ...
        flg = 1;
        break;
      } else if (this.mMasuSts[cnt2 - 1][cnt1 - 1] == ReversiConst2.REVERSI_STS_NONE) {
        break;
      }
    }
    if (flg == 1) {
  ...
  private AnalysisReversiBlack(): void {
    ...
    for (var cnt = 0; cnt < this.mMasuPointCntB; cnt++) {
      ...
      this.mMasuSts[tmpY][tmpX] = ReversiConst2.REVERSI_STS_BLACK; // 仮に置く
      this.revMasuSts(ReversiConst2.REVERSI_STS_BLACK, tmpY, tmpX); // 仮にひっくり返す
      this.makeMasuSts(ReversiConst2.REVERSI_STS_BLACK);
      this.makeMasuSts(ReversiConst2.REVERSI_STS_WHITE);
      // *** このマスに置いた場合の解析を行う *** //
      if (this.getColorEna(ReversiConst2.REVERSI_STS_WHITE) != 0) {
        // 相手がパス
      ...
      if (this.getEdgeSideZero(tmpY, tmpX) == 0) {
        ...
        if (this.checkEdge(ReversiConst2.REVERSI_STS_BLACK, tmpY, tmpX) != 0) {
          // 角を取られない
          this.mMasuStsAnzB[tmpY][tmpX].goodPoint +=
      ...
      for (var i = 0; i < this.mMasuCnt; i++) {
        for (var j = 0; j < this.mMasuCnt; j++) {
          tmpBadPoint = 0;
          tmpGoodPoint = 0;
          if (this.getMasuStsEna(ReversiConst2.REVERSI_STS_WHITE, i, j) != 0) {
          ...
          if (this.getMasuStsEna(ReversiConst2.REVERSI_STS_BLACK, i, j) != 0) {
      ...
      // *** 相手に取られる平均コマ数 *** //
      if (this.getPointCnt(ReversiConst2.REVERSI_STS_WHITE) != 0) {
        tmpD1 = sum;
        tmpD2 = this.getPointCnt(ReversiConst2.REVERSI_STS_WHITE);
        this.mMasuStsAnzB[tmpY][tmpX].avg = tmpD1 / tmpD2;
      }

      // *** 自分が取れる平均コマ数 *** //
      if (this.getPointCnt(ReversiConst2.REVERSI_STS_BLACK) != 0) {
        tmpD1 = sumOwn;
        tmpD2 = this.getPointCnt(ReversiConst2.REVERSI_STS_BLACK);
  ...
  private AnalysisReversiWhite(): void {
    ...
    for (var cnt = 0; cnt < this.mMasuPointCntW; cnt++) {
      ...
      this.mMasuSts[tmpY][tmpX] = ReversiConst2.REVERSI_STS_WHITE; // 仮に置く
      this.revMasuSts(ReversiConst2.REVERSI_STS_WHITE, tmpY, tmpX); // 仮にひっくり返す
      this.makeMasuSts(ReversiConst2.REVERSI_STS_BLACK);
      this.makeMasuSts(ReversiConst2.REVERSI_STS_WHITE);
      // *** このマスに置いた場合の解析を行う *** //
      if (this.getColorEna(ReversiConst2.REVERSI_STS_BLACK) != 0) {
        // 相手がパス
      ...
      if (this.getEdgeSideZero(tmpY, tmpX) == 0) {
        ...
        if (this.checkEdge(ReversiConst2.REVERSI_STS_WHITE, tmpY, tmpX) != 0) {
          // 角を取られない
          this.mMasuStsAnzW[tmpY][tmpX].goodPoint +=
  ...
  public getMasuStsEna(color: number, y: number, x: number): number {
    ...
    if (
      ...
      if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuStsEnaB[y][x];
  ...
  public getMasuStsCnt(color: number, y: number, x: number): number {
    ...
    if (
      ...
      if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuStsCntB[y][x];
  ...
  public getGameEndSts(): number {
    var ret: number = 1;
    if (this.getColorEna(ReversiConst2.REVERSI_STS_BLACK) == 0) ret = 0;
    if (this.getColorEna(ReversiConst2.REVERSI_STS_WHITE) == 0) ret = 0;
    return ret;
  }
  ...
  public getPoint(color: number, num: number): typeof ReversiPoint {
    ...
    if (this.checkPara(num, 0, this.mMasuCnt * this.mMasuCnt) == 0) {
      if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuPointB[num];
  ...
  public getPointCnt(color: number): number {
    var ret: number = 0;
    if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuPointCntB;
  ...
  public getBetCnt(color: number): number {
    var ret: number = 0;
    if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuBetCntB;
  ...
  public getPassEna(color: number, y: number, x: number): number {
    ...
    if (
      ...
      if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuStsPassB[y][x];
  ...
  public getPointAnz(color: number, y: number, x: number): typeof ReversiAnz {
    ...
    if (
      ...
      if (color == ReversiConst2.REVERSI_STS_BLACK) ret = this.mMasuStsAnzB[y][x];
  ...
  public checkEdge(color: number, y: number, x: number): number {
    ...
    if (y == 0 && x == 1) {
      for (loop = x, flg1 = 0, flg2 = 0; loop < this.mMasuCnt; loop++) {
        ...
        if (flg1 == 1 && this.getMasuSts(y, loop) == ReversiConst2.REVERSI_STS_NONE) break;
        if (
          flg1 == 1 &&
          this.getMasuSts(y, loop) != color &&
          this.getMasuSts(y, loop) != ReversiConst2.REVERSI_STS_NONE
        )
          flg2 = 1;
      }
    ...
    if (y == 1 && x == 0) {
      for (loop = y, flg1 = 0, flg2 = 0; loop < this.mMasuCnt; loop++) {
        ...
        if (flg1 == 1 && this.getMasuSts(loop, x) == ReversiConst2.REVERSI_STS_NONE) break;
        if (
          flg1 == 1 &&
          this.getMasuSts(loop, x) != color &&
          this.getMasuSts(loop, x) != ReversiConst2.REVERSI_STS_NONE
        )
          flg2 = 1;
      }
      if (flg1 == 1 && flg2 == 0) style = 1;
    ...
    if (y == 1 && x == 1) {
      for (loop = y, flg1 = 0, flg2 = 0; loop < this.mMasuCnt; loop++) {
        ...
        if (flg1 == 1 && this.getMasuSts(loop, loop) == ReversiConst2.REVERSI_STS_NONE) break;
        if (
          flg1 == 1 &&
          this.getMasuSts(loop, loop) != color &&
          this.getMasuSts(loop, loop) != ReversiConst2.REVERSI_STS_NONE
        )
          flg2 = 1;
      }
      if (flg1 == 1 && flg2 == 0) style = 1;
    ...
    if (y == 1 && x == this.mMasuCnt - 2) {
      for (
        ...
        if (flg1 == 1 && this.getMasuSts(loop, loop2) == ReversiConst2.REVERSI_STS_NONE)
          break;
        if (
          flg1 == 1 &&
          this.getMasuSts(loop, loop2) != color &&
          this.getMasuSts(loop, loop2) != ReversiConst2.REVERSI_STS_NONE
        )
          flg2 = 1;
      }
      if (flg1 == 1 && flg2 == 0) style = 1;
